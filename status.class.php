    ...
    class MinecraftServerStatus {
        ...
        public function getStatus($host = '127.0.0.1', $version = '1.7*' , $port = 25565) {
            ...
            if(preg_match('/1.7|1.8/',$version)) {
                ...
                $motd = preg_replace("/(§1)/", "<font color='#0000AA'>",$motd);
				$motd = preg_replace("/(§2)/", "<font color='#00AA00'>",$motd);
				$motd = preg_replace("/(§3)/", "<font color='#00AAAA'>",$motd);
				$motd = preg_replace("/(§4)/", "<font color='#AA0000'>",$motd);
				$motd = preg_replace("/(§5)/", "<font color='#AA00AA'>",$motd);
				$motd = preg_replace("/(§6)/", "<font color='#FFAA00'>",$motd);
				$motd = preg_replace("/(§7)/", "<font color='#AAAAAA'>",$motd);
				$motd = preg_replace("/(§8)/", "<font color='#555555'>",$motd);
				$motd = preg_replace("/(§9)/", "<font color='#5555FF'>",$motd);
				$motd = preg_replace("/(§a)/", "<font color='#55FF55'>",$motd);
				$motd = preg_replace("/(§b)/", "<font color='#55FFFF'>",$motd);
				$motd = preg_replace("/(§c)/", "<font color='#FF5555'>",$motd);
				$motd = preg_replace("/(§d)/", "<font color='#FF55FF'>",$motd);
				$motd = preg_replace("/(§e)/", "<font color='#FFFF55'>",$motd);
				$motd = preg_replace("/(§f)/", "<font color='#FFFFFF'>",$motd);
